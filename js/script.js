...
// Tamanho do quebra-cabeça (3x3)
const puzzleSize = 3;
const tileSize = canvas.width / puzzleSize; // Tamanho de cada peça
...
puzzleImage.onload = () => {
    ...
    drawPuzzle(); // Desenha o quebra-cabeça na tela
};
...
function initializePuzzle() {
    ...
    shufflePuzzle(); // Embaralha o quebra-cabeça
}

// Embaralha o quebra-cabeça aleatoriamente
...
// Desenha o quebra-cabeça na tela
function drawPuzzle() {
